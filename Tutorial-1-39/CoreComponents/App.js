...
export default function App() {
  return (
    <View style={[styles.text, styles.container]}>
      <Box style={{ backgroundColor: "green", top: 75,left:75 }} Children="Box 1" />
      <Box style={{ backgroundColor: "black", }} Children="Box 2" />
      <Box style={{ backgroundColor: "red",}} Children="Box 3" />
      <Box style={{ backgroundColor: "green", top: 75,left:75  }} Children="Box 4" />
      <Box style={{ backgroundColor: "yellow",position: "absolute", top: 150, left: 150 }} Children="Box 5" />
